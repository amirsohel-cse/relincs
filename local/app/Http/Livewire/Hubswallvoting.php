...
use App\Models\hubs_wall_like as Like;
use App\Models\User;
use App\Models\HubWall as Video;
use App\Models\hubs_wall_dislike as Dislike;
...
class Hubswallvoting extends Component
{
    public $video;
    public $likes;
    public $user;
    ...
    public function render()
    {
        ...
        return view('livewire.hubswallvoting');
    }
