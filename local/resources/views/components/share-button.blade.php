    ...
    <div class="bg-gray-100 w-full mx-4 p-4 rounded-xl md:w-1/2 lg:w-1/3">
        ...
        <div class="my-4">
            ...
            <div class="flex justify-around my-4">
                ...
                <!--TWITTER ICON-->
                <a href="https://twitter.com/intent/tweet?url={{request()->fullUrl()}}&text={{$title}}"
                ...
                <!--INSTAGRAM ICON-->
                <a href="https://www.instagram.com/?url={{request()->fullUrl()}}"
                ...
                <!--WHATSAPP ICON-->
                <a href="https://wa.me/send?text={{request()->fullUrl()}}"
                ...
                <!--TELEGRAM ICON-->
                <a href="https://telegram.me/share/url?url={{request()->fullUrl()}}&text={{$title}}"
