...
<a class="flex w-3/3 h-80 justify-center items-center shadow-md cursor-pointer rounded-md object-cover"
    href="{{ route('watch.hubs.wall',$data->uid) }}" x-data="{ hover : false , details : false }" @click="details = true"
    @mouseover="hover = true">
    <div class="w-full h-full relative rounded-md">
        <img src="{{ env('AWS_BUCKET_URL').$data->path }}" alt="news" class="rounded-md w-full h-full object-cover">
