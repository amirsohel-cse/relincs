...
<div style="background:#eee;">
    <div class="container">
        <div class="main-container">
            <h2 style="margin-top:0;">Cashei Terms of Use</h2>
            ...
            <div id="content">
                <p> By downloading or using the app, these terms will automatically apply to you – you should make
                    ...
                    database rights, and other intellectual property rights related to it, still belong to Hassan
                    Hussein. </p>
                <p> Hassan Hussein is committed to ensuring that the app is as useful and efficient as possible. For
                ...
                <p> The Cashei app stores and processes personal data that you have provided to us, to provide my
                    ...
                    phone’s security features and it could mean that the Cashei app won’t work properly or at all.
                </p>
                <div>
                ...
                <p> You should be aware that there are certain things that Hassan Hussein will not take
                    responsibility for. Certain functions of the app will require the app to have an active internet
                    connection. The connection can be Wi-Fi or provided by your mobile network provider, but Hassan
                    Hussein cannot take responsibility for the app not working at full functionality if you don’t
                ...
                <p> Along the same lines, Hassan Hussein cannot always take responsibility for the way you use the
                    app i.e. You need to make sure that your device stays charged – if it runs out of battery and
                    you can’t turn it on to avail the Service, Hassan Hussein cannot accept responsibility. </p>
                <p> With respect to Hassan Hussein’s responsibility for your use of the app, when you’re using the
                    ...
                    make it available to you. Hassan Hussein accepts no liability for any loss, direct or indirect,
                ...
                <p> At some point, we may wish to update the app. The app is currently available on Android &amp;
                    iOS – the requirements for the both systems(and for any additional systems we decide to extend
                    the availability of the app to) may change, and you’ll need to download the updates if you want
                    to keep using the app. Hassan Hussein does not promise that it will always update the app so
                    that it is relevant to you and/or works with the Android &amp; iOS version that you have
                    installed on your device. However, you promise to always accept updates to the application when
                    offered to you, We may also wish to stop providing the app, and may terminate use of it at any
                    time without giving notice of termination to you. Unless we tell you otherwise, upon any
                    termination, (a) the rights and licenses granted to you in these terms will end; (b) you must
                    stop using the app, and (if needed) delete it from your device. </p>
                ...
                <p> If you have any questions or suggestions about my Terms and Conditions, do not hesitate to
                    contact me at contact@cashei.app. </p>
            </div>
        </div>
