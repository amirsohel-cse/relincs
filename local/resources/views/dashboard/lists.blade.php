<x-app-layout>
    ...
    <div class="w-full">
        <div class="container md:px-4 px-2 py-6 flex flex-col justify-start items-start" wire:loading.class="opacity-50">
                ...
                <table class="w-full rounded-md">
                    ...
                    <tbody>
                        <tr class="border-b border-gray-100">
                            <td class="text-center py-3 border-r border-gray-100">

                                <div class="px-2 py-6 flex flex-col justify-center items-center">
                                    <div
                                        class="bg-transparent p-2 w-80 w-full sm:w-full h-auto sm:h-64 rounded-lg flex flex-col sm:flex-row gap-5 select-none">
                                        <div
                                            class="relative h-52 sm:h-full sm:w-72 rounded-xl bg-gray-100 bg-center bg-cover object-cover">
                                            <img src="{{asset('storage/img/post1.jpg')}}" alt="result"
                                ...
                                <div class="flex flex-col mx-3">
                                    <div
                                        ...
                                        <div
                                            ...
                                            <svg class="md:w-6 w-5 h-5 md:h-6 text-indigo-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 8h14M5 8a2 2 0 110-4h14a2 2 0 110 4M5 8v10a2 2 0 002 2h10a2 2 0 002-2V8m-9 4h4"></path></svg>
                                            <div class="md:flex hidden text-gray-700 capitalize">
                                                &nbsp; freeze
                                            </div>
                                        </div>
                                ...
                                <div class="px-2 py-6 flex flex-col justify-center items-center">
                                    <div
                                        ...
                                        <div class="flex sm:flex-1 flex-col gap-2 p-1">
                                            ...
                                            <button
                                                class='border border-gray-200 rounded-full hover:bg-indigo-300 w-20 flex items-center justify-center bg-indigo-200 gap-1 sm:tmd-30-2px-3 p-50 transition-colors focus:bg-gray-bg-gray-800 focus:outline-none focus-visible:border-gray-500'>
                                                <span>public</span>
                                            </button>
                                            <div class="flex gap-4 md:mt-auto mt-5">
                                                <button
