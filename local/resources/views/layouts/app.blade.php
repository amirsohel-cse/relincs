...
<body class="select-none" x-data="{
    ...
    {{-- <div class="flex h-screen bg-gray-50 overflow-y-auto  scrollere  overflow-x-hidden w-full"> --}}
    <!-- Desktop sidebar -->
    <div class="relative z-50">
        <div class="z-50">
                    ...
                    <div x-data="{ open: false }"
                        ...
                        <div class="flex flex-row items-center justify-between px-4">
                            ...
                            <div class="relative flex justify-center items-center lg:ml-20 ml-0">
                                {{-- <button
                                        class="flex items-center justify-center rounded-lg focus:outline-none focus:shadow-outline"
                                        @click="openSearch = !openSearch">
                                        <svg class=" w-5 text-gray-800 h-5 cursor-pointer" fill="none"
                                            stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            stroke="currentColor" viewBox="0 0 24 24">
                                            <path d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"></path>
                                        </svg>
                                        <p class="text-sm ml-2 lg:flex hidden font-base text-gray-500">Search...</p>
                                    </button> --}}
                                @if (request()->routeIs('gu.media'))
            ...
            {{-- <div :class="openSearch === true ? 'hidden' : 'flex -bottom-14' "
                    class="absolute z-50 left-0 right-0 top-0 justify-end items-center w-10 lg:mx-auto lg:flex hidden"
                    :class="toggleMenu == false ? 'bottom-0' : '-bottom-14' ">
                    <button @click="toggleMenu = !toggleMenu" type="buttom"
                        :class="toggleMenu ? 'bg-transparent text-gray-500' : 'bg-indigo-600 shadow-md text-white ' "
                        class="rounded-full  mx-auto flex justify-center items-center p-2">
                        <svg class="" :class="toggleMenu ? 'w-7 h-7' : 'w-5 h-5'" fill="none" stroke="currentColor"
                            viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.2" d="M1 8h50M1 14h50">
                            </path>
                        </svg>
                    </button>
                </div> --}}
        ...
        <div class="lg:px-8 px-4 pb-16 pt-4 flex lg:flex-row flex-col items-center bg-gray-100 justify-between">
            ...
            <div class="flex justify-center items-center space-x-4 lg:mt-1 mt-3">
                ...
                <a href="{{ $setting->instagram_url }}" target="_blank" class="w-8">
                    <svg role="img" class="text-gray-600" viewBox="0 0 24 24"
                        xmlns="http://www.w3.org/2000/svg">
