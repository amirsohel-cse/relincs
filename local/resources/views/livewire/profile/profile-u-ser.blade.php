<div class="w-full ">
                ...
                <div
                    ...
                    <div class="flex lg:flex-row flex-col justify-start items-center lg:gap-x-3 gap-y-4 text-gray-800">
                        ...
                        <div class="flex w-full">
                            <div></div>
                            {{-- <a class="font-bold px-4 py-2 text-xs mt-2 mr-2  hover:bg-midsky transition duration-100 rounded-lg lg:mt-0 lg:ml-4 focus:text-gray-900 hover:text-gray-50 focus:bg-gray-200 lg:text-left text-center focus:outline-none focus:shadow-outline"
                            href="{{ route('dash.page.marked') }}">Saveds</a> --}}
                            <div>
                                ...
                                href="{{url('chatify/'.$user->id)}}">Message</a>
                            </div>
                            <div>
                                @livewire('following', ['user_id' => $user->id])
                            </div>
                            <button class="ml-4 relative"  wire:click.prevent="bookmarking">
                                <svg class="w-7 h-7 text-gray-700 @if($marked) fill-current @endif"
                    ...
                    <div class="mt-0">
                                    ...
                                    <div class="flex-none flex md:flex-row flex-col cursor-pointer">
                                        <a href="{{ route('show.wall.feed' , ['video' => $i->uid,]) }}"
                                            ...
                                            <a target="_blank"
                                                ...
                                                @if ($i->thumbnail_image == null)
                                                {{-- <svg class="md:w-12 md:h-12 w-8 h-8" fill="none"
                        ...
                        {{-- <div class="" x-show=" tab_profile==='favourites' ">
                            <div class="    my-6 md:px-4 px-2">
                                ...
                                <div class="my-6 md:px-4 px-2">
                                    <div class="my-4">
                                        <h3 class="mx-2 font-bold text-black text-xl capitalize">hubs channel
                                        </h3>
                                    </div>
                                    <div class="grid md:grid-cols-5 grid-cols-2 md:gap-4 gap-3">
                                        <div href="#"
                            ...
                            <div class="my-8 px-3 w-full grid lg:grid-cols-12 gap-x-10 gap-y-6">
                                <div class="w-full  col-span-7">
                                    <div
                                        ...
                                        <p class="text-left mt-1 font-base leading-7 lg:text-md text-sm"> {!!
                                            $user->about !!}</p>
                                    </div>
                                </div>
                                <div class="w-full  col-span-5 md:text-lg text-md text-gray-700 lg:mt-1 mt-3">
                                    ...
                                    <div class="flex justify-start items-center ">
                                        ...
                                        <a target="_blank" href="https://{{$user->link}}"
                                            class="flex justify-center items-center text-indigo-500 underline py-4 px-2">
                                            {{ Illuminate\Support\Str::limit($user->link , 20)}}
                                        </a>
                                    </div>
                                </div>
                            </div>
    ...
    <div class="absolute inset-0 bg-gray-900 w-full h-full bg-opacity-60">
        ...
        @livewire('list-follow' ,['user' => $user->id], key($user->id) )
                </div>
    </div>
</div>
    ...
    {{-- <div x-show="opimg"="opimg = false" x-transition:enter="transition ease-out duration-300"
        x-transition:enter-start="opacity-0 scale-90" x-transition:enter-end="opacity-100 scale-100"
        x-transition:leave="transition ease-in duration-300" x-transition:leave-start="opacity-100 scale-100"
        x-transition:leave-end="opacity-0 scale-90"
        class="w-full h-full flex justify-center items-center absolute inset-0 bg-gray-800 bg-opacity-60">
        <div class="lg:w-5/12 w-10/12 mx-auto my-6 " @mousedown.away="opimg = false">
