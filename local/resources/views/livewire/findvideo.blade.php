                ...
                <div class="mx-auto w-full flex flex-row justify-between  py-4 z-50">
                    <form wire:submit.prevent="find"
                        ...
                        <select class="px-4 lg:w-32 w-20 lg:text-md text-sm outline-none border-none h-full bg-transparent capitalize
                            @error('type')  text-red-400  @enderror" wire:model.defer="type" id="type">
        ...
        <ul class="grid lg:grid-cols-5 grid-cols-2 gap-6">
            ...
            <li class="flex flex-col items-center space-y-1 ">
                <div class="bg-gradient-to-tr from-sky via-sky to-indigo-600 p-1 rounded-full">
                    <a href="{{ route('show.hubs' , $data->uid) }}" class=" bg-white block rounded-full p-1 hover:-rotate-6 transform transition" href="#">
                        <img class="h-32 w-32 rounded-full" src="{{ asset('storage/storage/profile_hubs/'.$data->profile) }}" alt="cute kitty" />
                    </a>
                </div>
            ...
            <li class="flex flex-col items-center space-y-1 ">
                <div class="bg-gradient-to-tr from-sky via-sky to-indigo-600 p-1 rounded-full">
                    <a href="{{route('gu.ehubs')}}" class=" bg-white block rounded-full p-1 hover:-rotate-6 transform transition" href="#">
