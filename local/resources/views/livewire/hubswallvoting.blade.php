<div>
    <div class="flex justify-between items-start">
        ...
        {{-- <div class="flex space-x-2 items-center" wire:loading.class="opacity-50">
            <button type="button" class="focus:outline-none" wire:click="mark">
                <svg class="w-8 h-8 text-gray-600  @if ($marked) text-gray-900 fill-current transition duration-200  @endif"
