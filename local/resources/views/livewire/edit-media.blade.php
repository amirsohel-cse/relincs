<div class="w-full">
    ...
    <div class="w-full" wire:target="update" wire:loading.class="opacity-50">
        <form wire:submit.prevent="update">
            <div class="relative flex flex-col w-full md:px-10 px-3" @if ($this->media->processed_persentage < 100)
                    wire:poll @endif>
                    <div class=" flex w-full flex-col space-y-3">
                        <div class="flex justify-between items-center w-full mb-3">
                            <div class="w-5/12">
                                ...
                                <img src="{{ $cover ? $cover->temporaryUrl() : env('AWS_BUCKET_URL').'media/'.$this->media->uid.'/'.$this->media->thumbnail_image  }}"
                                {{-- asset($this->media->getThumbnailAttribute()) --}}
                                    alt="{{ $this->media->title }}" class="w-96 h-60 object-cover">
                            </div>
                            <div class="w-4/12">
                            ...
                            <div class=" flex flex-col w-3/12">
                                <p class="text-gray-600 font-base">
                                    Processeing
                                    <span class="font-medium text-gray-600">({{ $this->media->processed_persentage
                                        }})%</span>
                                </p>
                    ...
                    <div class="grid md:grid-cols-2 grid-cols-1 align-content-center  gap-6 w-full">
                        ...
                        <div class=" flex w-full flex-col space-y-3">
                            ...
                            <x-input id="title" class="block mt-2 w-full" type="text" wire:model="media.title" required
