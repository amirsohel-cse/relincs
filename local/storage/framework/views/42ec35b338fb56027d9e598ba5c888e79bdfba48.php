...
} elseif ($_instance->childHasBeenRendered('2pdQFB2')) {
    $componentId = $_instance->getRenderedChildComponentId('2pdQFB2');
    $componentTag = $_instance->getRenderedChildComponentTagName('2pdQFB2');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('2pdQFB2');
} else {
    $response = \Livewire\Livewire::mount('admin.layouts.inc.sidebar');
    $html = $response->html();
    $_instance->logRenderedChild('2pdQFB2', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    <?php
...
} elseif ($_instance->childHasBeenRendered('lXJ5de3')) {
    $componentId = $_instance->getRenderedChildComponentId('lXJ5de3');
    $componentTag = $_instance->getRenderedChildComponentTagName('lXJ5de3');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('lXJ5de3');
} else {
    $response = \Livewire\Livewire::mount('admin.layouts.inc.navbar');
    $html = $response->html();
    $_instance->logRenderedChild('lXJ5de3', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('JZkoHdc')) {
    $componentId = $_instance->getRenderedChildComponentId('JZkoHdc');
    $componentTag = $_instance->getRenderedChildComponentTagName('JZkoHdc');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('JZkoHdc');
} else {
    $response = \Livewire\Livewire::mount('admin.layouts.inc.footer');
    $html = $response->html();
    $_instance->logRenderedChild('JZkoHdc', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        </div>
