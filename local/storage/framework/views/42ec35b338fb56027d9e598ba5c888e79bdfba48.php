...
} elseif ($_instance->childHasBeenRendered('t20yyqq')) {
    $componentId = $_instance->getRenderedChildComponentId('t20yyqq');
    $componentTag = $_instance->getRenderedChildComponentTagName('t20yyqq');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('t20yyqq');
} else {
    $response = \Livewire\Livewire::mount('admin.layouts.inc.sidebar');
    $html = $response->html();
    $_instance->logRenderedChild('t20yyqq', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    <?php
...
} elseif ($_instance->childHasBeenRendered('P0IrKfi')) {
    $componentId = $_instance->getRenderedChildComponentId('P0IrKfi');
    $componentTag = $_instance->getRenderedChildComponentTagName('P0IrKfi');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('P0IrKfi');
} else {
    $response = \Livewire\Livewire::mount('admin.layouts.inc.navbar');
    $html = $response->html();
    $_instance->logRenderedChild('P0IrKfi', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('zae6iph')) {
    $componentId = $_instance->getRenderedChildComponentId('zae6iph');
    $componentTag = $_instance->getRenderedChildComponentTagName('zae6iph');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('zae6iph');
} else {
    $response = \Livewire\Livewire::mount('admin.layouts.inc.footer');
    $html = $response->html();
    $_instance->logRenderedChild('zae6iph', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        </div>
