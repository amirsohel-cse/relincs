...
} elseif ($_instance->childHasBeenRendered('IvO3tjT')) {
    $componentId = $_instance->getRenderedChildComponentId('IvO3tjT');
    $componentTag = $_instance->getRenderedChildComponentTagName('IvO3tjT');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('IvO3tjT');
} else {
    $response = \Livewire\Livewire::mount('admin.layouts.inc.sidebar');
    $html = $response->html();
    $_instance->logRenderedChild('IvO3tjT', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    <?php
...
} elseif ($_instance->childHasBeenRendered('ssWSQMp')) {
    $componentId = $_instance->getRenderedChildComponentId('ssWSQMp');
    $componentTag = $_instance->getRenderedChildComponentTagName('ssWSQMp');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('ssWSQMp');
} else {
    $response = \Livewire\Livewire::mount('admin.layouts.inc.navbar');
    $html = $response->html();
    $_instance->logRenderedChild('ssWSQMp', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('JQTImVL')) {
    $componentId = $_instance->getRenderedChildComponentId('JQTImVL');
    $componentTag = $_instance->getRenderedChildComponentTagName('JQTImVL');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('JQTImVL');
} else {
    $response = \Livewire\Livewire::mount('admin.layouts.inc.footer');
    $html = $response->html();
    $_instance->logRenderedChild('JQTImVL', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        </div>
