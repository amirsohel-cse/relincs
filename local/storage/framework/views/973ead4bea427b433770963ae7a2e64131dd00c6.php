...
} elseif ($_instance->childHasBeenRendered('ddTrYjF')) {
    $componentId = $_instance->getRenderedChildComponentId('ddTrYjF');
    $componentTag = $_instance->getRenderedChildComponentTagName('ddTrYjF');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('ddTrYjF');
} else {
    $response = \Livewire\Livewire::mount('following', ['user_id' => $user->id]);
    $html = $response->html();
    $_instance->logRenderedChild('ddTrYjF', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                                </div>
...
<?php endif; ?>
<?php /**PATH /var/www/relincs.com/htdocs/local/resources/views/dashboard/index.blade.php ENDPATH**/ ?>