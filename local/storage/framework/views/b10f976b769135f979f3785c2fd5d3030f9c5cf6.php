            ...
            <div class="w-full">
                <table class="w-full rounded-md">
                    ...
                    <tbody class="w-full flex justify-center items-center flex-col space-y-4">
                        <?php $__currentLoopData = $videos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <tr class="border-b border-gray-100 w-full relative">
                            <td class="text-center py-3 border-r border-gray-100 w-full relative">
                                ...
                                <a href="<?php echo e(route('show.wall.feed',$i->uid)); ?>"
                                    class="<?php if($i->status == 1): ?> filter blur-sm <?php endif; ?> px-2 py-6 flex flex-col justify-center items-center w-full">
                                    <div
                                        ...
                                        <div
                                            ...
                                            <?php if(str_contains($i->path,'.mp4')): ?>
                                            <img src="<?php echo e(env('AWS_BUCKET_URL').'video/'. $i->uid.'/'.$i->thumbnail_image); ?>" alt="<?php echo e($i->title); ?>"
                                                class="object-cover bg-cover rounded-xl h-52 sm:h-full sm:w-72">
                                            <?php else: ?>
                                            <img src="<?php echo e(env('AWS_BUCKET_URL'). $i->path); ?>" alt="<?php echo e($i->title); ?>"
                                                class="object-cover bg-cover rounded-xl h-52 sm:h-full sm:w-72">
                                            <?php endif; ?>
                            ...
                            <td class="text-center py-3 w-full">
                                ...
                                <div class="flex flex-col mx-3 w-full">
                                    <div
                                        ...
                                        <?php if($i->status === 0): ?>
                                        <a href="<?php echo e(route('dash.edit.video', ['video' => $i->uid])); ?>"
                                        ...
                                        <div wire:click.prevent="confirmDelete('<?php echo e($i->uid); ?>')"
                                        ...
                                        <?php endif; ?>
                                        <button wire:click.prevent="Freeze('<?php echo e($i->uid); ?>')"
...
<?php /**PATH C:\laragon\www\relincs\local\resources\views/livewire/allvideos.blade.php ENDPATH**/ ?>