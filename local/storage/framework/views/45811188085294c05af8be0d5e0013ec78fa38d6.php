...
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.label','data' => ['for' => 'profile','value' => __('your file')]]); ?>
<?php $component->withName('label'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['for' => 'profile','value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('your file'))]); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="w-full flex flex-col">
                                <?php if($filevideo): ?>
                                <?php if(str_contains($filevideo->temporaryUrl(),'.mp4')): ?>
                                    <iframe src="<?php echo e($filevideo->temporaryUrl()); ?>" frameborder="0" class="w-full h-80"></iframe>
                                <?php else: ?>
                                    <img src="<?php echo e($filevideo->temporaryUrl()); ?>" class="w-full object-cover h-80">
                                <?php endif; ?>
                                <?php endif; ?>
                            </div>
                        </div>
...
<?php /**PATH /var/www/relincs.com/htdocs/local/resources/views/livewire/video/create.blade.php ENDPATH**/ ?>