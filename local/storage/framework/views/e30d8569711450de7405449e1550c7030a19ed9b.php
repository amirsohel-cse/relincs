                                ...
                                <div class="col-sm-9">
                                    <div class="form-check form-switch form-switch-success" style="margin-left: 25px; margin-top: 5px;">
                                        <input class="form-check-input showMedia" type="checkbox"
                                            id="customSwitchSuccess" <?php if($show_latest_page_media == 1): ?> checked <?php endif; ?>>
                                    </div>
                                </div>
                            </div>
                        </form>
...
<script>
        $(document).ready(function(){
            $('.showMedia').on('click', function(){
                window.livewire.find('<?php echo e($_instance->id); ?>').changeMediaStatus();
            });
        });
</script>
<?php $__env->stopPush(); ?><?php /**PATH C:\laragon\www\relincs\local\resources\views/livewire/admin/setting/webpage-settings.blade.php ENDPATH**/ ?>