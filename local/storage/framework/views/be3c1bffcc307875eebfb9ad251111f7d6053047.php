<div class="w-full">
    <?php $__env->startSection('title'); ?> List Wall of Hubs <?php $__env->stopSection(); ?>

     <?php $__env->slot('header', null, []); ?> 
        <?php echo e(__('List Wall of Hubs')); ?>
            ...
            <div class="container md:px-4 px-2 py-6 flex flex-col justify-start items-start w-full">
                ...
                <div class="w-full">
                    <table class="w-full rounded-md">
                        ...
                        <tbody class="w-full">
                            <?php $__currentLoopData = $media_hubs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                            <tr class="border-b border-gray-100 w-full">

                                <td class="text-center py-3 border-r border-gray-100 w-full">
                                    <a href="<?php echo e(route('watch.hubs.wall', $i->uid)); ?>"
                                        ...
                                        <div
                                            ...
                                            <div
                                                class="relative w-68 h-68 rounded-xl bg-gray-100 bg-center bg-cover object-cover">
                                                <img src="<?php echo e(env('AWS_BUCKET_URL').$i->path); ?>"
                                                    alt="<?php echo e($i->title); ?>"
                                                    class="object-cover bg-cover rounded-xl h-full w-full">
                                            </div>
                                ...
                                <td class="text-center py-3 w-full">
                                    ...
                                    <div class="flex flex-col mx-3 w-full">
                                        <div
                                            ...
                                            <a href="<?php echo e(route('dash.update.wall.hubs', ['hubmedia' => $i->uid])); ?>"
                                            ...
                                            <div wire:click.prevent="delete('<?php echo e($i->id); ?>')"
...
<?php /**PATH /var/www/relincs.com/htdocs/local/resources/views/livewire/hubs/wall/listwall.blade.php ENDPATH**/ ?>