        ...
        <div class="column2" style="text-align: center;">
            <div style="width: 100%; display: flex; margin-top: 20%;">
                <div style="width: 50%; text-align: center; margin-right: 10px;">
                    ...
                    <a href="<?php echo e(asset('local/public/app/cashei.apk')); ?>" class="btn" download><img src="<?php echo e(asset('assets/images/android-download.png')); ?>" style="height: 100px;" alt=""></a>
                </div>
