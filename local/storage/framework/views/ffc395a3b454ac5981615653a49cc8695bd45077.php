...
} elseif ($_instance->childHasBeenRendered('jImGxwI')) {
    $componentId = $_instance->getRenderedChildComponentId('jImGxwI');
    $componentTag = $_instance->getRenderedChildComponentTagName('jImGxwI');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('jImGxwI');
} else {
    $response = \Livewire\Livewire::mount('join', ['user_id' => $data->user_id]);
    $html = $response->html();
    $_instance->logRenderedChild('jImGxwI', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                    </div>
