<div class="w-full">
    ...
    <?php $__env->startPush('scripts'); ?>
        <script>
            window.addEventListener('wll_uploaded', () => {
                Swal.fire({
                icon : 'success',
                title: 'Successfully',
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="lg:col-span-1 col-span-2 flex w-full flex-col space-y-3 lg:itsems-center">
                        <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
...
<?php /**PATH /var/www/relincs.com/htdocs/local/resources/views/livewire/hubs/wall/create.blade.php ENDPATH**/ ?>