            ...
            <div class="py-2 px-1">
                <div class="flex justify-between items-center py-2">
                    <div class="relative mt-1 flex">
                        <div class="mr-2">
                            <img src="<?php echo e($user->profile()); ?>" alt="saman sayyar"
...
} elseif ($_instance->childHasBeenRendered('l297730007-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l297730007-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l297730007-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l297730007-0');
} else {
    $response = \Livewire\Livewire::mount('all-comments', ['video' => $video]);
    $html = $response->html();
    $_instance->logRenderedChild('l297730007-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('l297730007-2')) {
    $componentId = $_instance->getRenderedChildComponentId('l297730007-2');
    $componentTag = $_instance->getRenderedChildComponentTagName('l297730007-2');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l297730007-2');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('l297730007-2', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
</div><?php /**PATH /var/www/relincs.com/htdocs/local/resources/views/livewire/show-feed.blade.php ENDPATH**/ ?>