    ...
    <div class="w-full" wire:target="update" wire:loading.class="opacity-50">
        <form wire:submit.prevent="update">
            <div class="relative flex flex-col w-full md:px-10 px-3"
             <?php if($this->video->processed_persentage < 100): ?>
                wire:poll
            <?php endif; ?>
                >
                <div class="grid md:grid-cols-2 grid-cols-1 align-content-center  gap-6 w-full">
                    <div class=" flex w-full flex-col space-y-3 lg:col-span-1  <?php if($video->thumbnail_image == null): ?>
                        lg:col-span-2
                    <?php endif; ?>">
                        <div class="flex justify-between items-center w-full">
                            <img src="<?php echo e($video->getThumbnailAttribute()); ?>" alt="<?php echo e($this->video->title); ?>"
                                class="w-96">
                        </div>
                        
                </div>
                <div class=" flex w-full flex-col space-y-3 col-span-1 <?php if($video->thumbnail_image == null): ?>
                        hidden
                    <?php endif; ?>">
                    <p class="text-gray-600 font-base">
                        Processeing
                        <span class="font-medium text-gray-600">(<?php echo e($this->video->processed_persentage); ?>)%</span>
...
<?php endif; ?>
                        <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.input','data' => ['id' => 'title','class' => 'block mt-2 w-full','type' => 'text','wire:model' => 'video.title','required' => true,'autocomplete' => 'current-title']]); ?>
<?php $component->withName('input'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['id' => 'title','class' => 'block mt-2 w-full','type' => 'text','wire:model' => 'video.title','required' => true,'autocomplete' => 'current-title']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
...
<?php endif; ?>
                        ...
                        <?php $__errorArgs = ['video.visibility'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
<?php /**PATH /var/www/relincs.com/htdocs/local/resources/views/livewire/video/edit-video.blade.php ENDPATH**/ ?>