...
} elseif ($_instance->childHasBeenRendered('l1171500499-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l1171500499-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l1171500499-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l1171500499-0');
} else {
    $response = \Livewire\Livewire::mount('following', ['user_id' => $user->id]);
    $html = $response->html();
    $_instance->logRenderedChild('l1171500499-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                            </div>
                                ...
                                <div class="grid lg:grid-cols-4 grid-cols-3 md:gap-2 gap-1">
                                    ...
                                    <div class="flex-none flex md:flex-row flex-col cursor-pointer">
                                        <a href="<?php echo e(route('show.wall.feed' , ['video' => $i->uid,])); ?>"
                                            ...
                                            <img src="<?php echo e($i->thumbnail_image == null ?  asset($i->path) : asset('video/' . $i->uid . '/' . $i->thumbnail_image)); ?>"
                                                alt="SamanSayyar"
                            ...
                            <div class="lg:mt-4 mt-0 lg:px-4 px-0">
                                ...
                                <div class="grid lg:grid-cols-3 grid-cols-2 md:gap-2 gap-1">
                                    ...
                                    <div class="flex-none flex md:flex-row flex-col cursor-pointer">
                                        <div
                                            class="relative flex justify-center items-center sm:mb-0 mb-3 w-full h-full">
                                            <img src="<?php echo e(asset('storage/media/' . $i->uid . '/' . $i->thumbnail_image)); ?>"
                                                alt="SamanSayyar"
...
<?php /**PATH /var/www/relincs.com/htdocs/local/resources/views/livewire/profile/profile-u-ser.blade.php ENDPATH**/ ?>