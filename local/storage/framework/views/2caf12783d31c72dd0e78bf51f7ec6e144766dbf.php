                    ...
                    <div class="w-full">
                        <div class="container w-full" wire:ignore>
                            <video id="watchwall" class="video-js vjs-fluid vjs-styles=default vjs-big-play-centered"
                                ...
                                poster="<?php echo e(env('AWS_BUCKET_URL').'hubs/media/'.$media->uid.'/'.$media->thumbnail_image); ?>">
                                <source src="<?php echo e(env('AWS_BUCKET_URL').'hubs/media/'.$media->uid.'/'.$media->processed_file); ?>"
                            ...
                            <div class="flex flex-row justify-between items-center border-b border-gray-100 pb-3">
                                <div class="flex justify-center items-center">
                                    <div class="w-full h-full">
                                        <img src="<?php echo e(asset('storage/storage/profile_hubs/'.$hub->profile)); ?>" alt="picture user"
...
} elseif ($_instance->childHasBeenRendered('l1927096623-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l1927096623-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l1927096623-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l1927096623-0');
} else {
    $response = \Livewire\Livewire::mount('join', ['user_id' => $hub->id]);
    $html = $response->html();
    $_instance->logRenderedChild('l1927096623-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                            </div>
...
} elseif ($_instance->childHasBeenRendered('l1927096623-1')) {
    $componentId = $_instance->getRenderedChildComponentId('l1927096623-1');
    $componentTag = $_instance->getRenderedChildComponentTagName('l1927096623-1');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l1927096623-1');
} else {
    $response = \Livewire\Livewire::mount('add-comment-media',['data' => $media,'col' => 0]);
    $html = $response->html();
    $_instance->logRenderedChild('l1927096623-1', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                            </div>
                ...
                <div class="flex justify-start lg:col-span-4 col-span-12">
                    <div class="flex flex-col lg:space-x-2 space-y-3 lg:w-auto w-full">
                        ...
                        <div class=" flex lg:w-full w-80 flex-row  ml-2 hover:bg-gray-100 transition duration-200">
                            <a href="<?php echo e(route('watch.hubs.media' , $i->uid)); ?>" class="w-full mr-2">
                                <img src="<?php echo e(env('AWS_BUCKET_URL').'hubs/media/'.$i->uid.'/'.$i->thumbnail_image); ?>" alt="<?php echo e($i->title); ?>"
...
<?php /**PATH /var/www/relincs.com/htdocs/local/resources/views/livewire/watch-hub-media.blade.php ENDPATH**/ ?>