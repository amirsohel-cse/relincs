...
<div style="z-index: 999999" id="" x-show="share"
    class="fixed inset-0 h-full backdrop-blur-md backdrop-filter bg-gray-800/50 flex items-center justify-center">
    <!--MODAL ITEM-->
    <div class="bg-gray-100 w-full mx-4 p-4 rounded-xl md:w-1/2 lg:w-1/3">
        ...
        <div class="my-4">
            ...
            <div class="flex justify-around my-4">
                <!--FACEBOOK ICON-->
                <a href="https://www.facebook.com/sharer/sharer.php?u=<?php echo e(request()->fullUrl()); ?>"
                ...
                <!--TWITTER ICON-->
                <a href="https://twitter.com/intent/tweet?url=<?php echo e(request()->fullUrl()); ?>&text=<?php echo e($title); ?>"
                ...
                <!--INSTAGRAM ICON-->
                <a href="https://www.instagram.com/?url=<?php echo e(request()->fullUrl()); ?>"
                ...
                <!--WHATSAPP ICON-->
                <a href="https://wa.me/send?text=<?php echo e(request()->fullUrl()); ?>"
                ...
                <!--TELEGRAM ICON-->
                <a href="https://telegram.me/share/url?url=<?php echo e(request()->fullUrl()); ?>&text=<?php echo e($title); ?>"
            ...
            <!--BOX LINK-->
            <div class="border-2 border-gray-200 flex justify-between items-center mt-4 py-2 space-x-2">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                ...
                <input id="urlpage" class="w-full leading-none text-gray-900 px-3 py-2 focus:outline-none focus:border-indigo-700 bg-gray-100 border rounded border-gray-200" type="text" placeholder="link"
                    value="<?php echo e(request()->fullUrl()); ?>">

                <button onclick="CopyText()" class="bg-indigo-500 text-white rounded text-sm py-3 px-5 ml-2 hover:bg-indigo-600">
                    Copy
                </button>
            </div>
        </div>
    </div>
</div><?php /**PATH /var/www/relincs.com/htdocs/local/resources/views/components/share-button.blade.php ENDPATH**/ ?>