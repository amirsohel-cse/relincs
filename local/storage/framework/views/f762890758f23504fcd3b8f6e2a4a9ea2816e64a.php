        ...
        <div class="m-header">
            ...
            <div class="messenger-listView-tabs">
                <a href="#" <?php if($type == 'user'): ?> class="active-tab" <?php endif; ?> data-view="users">
                    <span class="far fa-user"></span> Chats</a>
            </div>
        </div>
        ...
        <div class="m-header m-header-messaging">
            <nav>
                ...
                <div style="display: inline-flex;">
                    ...
                    <a href="#" class="user-name usernames"></a>
                </div>
...
<?php /**PATH /var/www/relincs.com/htdocs/local/resources/views/vendor/Chatify/pages/app.blade.php ENDPATH**/ ?>