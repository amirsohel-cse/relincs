...
<table class="messenger-list-item" data-contact="<?php echo e($user->id); ?>">
    <tr data-action="0">
        ...
        <div class="w-full avatar av-m">
            <img src="<?php echo e('https://relincsca.s3.amazonaws.com/public/profile_image/'.$user->image_profile); ?>" class="w-14 h-14 rounded-full shadow"/>
        </div>
        </td>
...
<?php /**PATH C:\laragon\www\relincs\local\resources\views/vendor/Chatify/layouts/listItem.blade.php ENDPATH**/ ?>