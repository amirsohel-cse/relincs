                                            ...
                                            <?php $__currentLoopData = $my_hubs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $i): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    ...
                                                    <td
                                                        ...
                                                        <form action="<?php echo e(route('dash.destroy.hubs', $i->id)); ?>"
                                                            id="deleteForm_<?php echo e($i->id); ?>" method="POST">
                                                            <?php echo csrf_field(); ?>
...
<?php /**PATH C:\laragon\www\relincs\local\resources\views/hubs/create.blade.php ENDPATH**/ ?>