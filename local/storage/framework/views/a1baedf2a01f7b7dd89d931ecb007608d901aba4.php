...
} elseif ($_instance->childHasBeenRendered('8MHru7M')) {
    $componentId = $_instance->getRenderedChildComponentId('8MHru7M');
    $componentTag = $_instance->getRenderedChildComponentTagName('8MHru7M');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('8MHru7M');
} else {
    $response = \Livewire\Livewire::mount('search-engine');
    $html = $response->html();
    $_instance->logRenderedChild('8MHru7M', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        </div>
