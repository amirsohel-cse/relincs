...
} elseif ($_instance->childHasBeenRendered('AWIVPxG')) {
    $componentId = $_instance->getRenderedChildComponentId('AWIVPxG');
    $componentTag = $_instance->getRenderedChildComponentTagName('AWIVPxG');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('AWIVPxG');
} else {
    $response = \Livewire\Livewire::mount('search-engine');
    $html = $response->html();
    $_instance->logRenderedChild('AWIVPxG', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        </div>
