                ...
                <form wire:submit.prevent="submitContactMessage">
                    <?php if(session()->has('success_message')): ?>
                        <div class="flex flex-col sm:justify-center items-center">
                            <div class="p-3 mt-5 text-center" style="background: rgb(119, 194, 119); width: 65%; border-radius: 3px;"><?php echo e(session()->get('success_message')); ?></div>
                        </div>
                    <?php endif; ?>
...
</div><?php /**PATH C:\laragon\www\relincs\local\resources\views/livewire/app/pages/contact-us-component.blade.php ENDPATH**/ ?>