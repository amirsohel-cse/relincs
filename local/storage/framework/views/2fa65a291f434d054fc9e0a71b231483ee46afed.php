...
} elseif ($_instance->childHasBeenRendered('SKPg0WA')) {
    $componentId = $_instance->getRenderedChildComponentId('SKPg0WA');
    $componentTag = $_instance->getRenderedChildComponentTagName('SKPg0WA');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('SKPg0WA');
} else {
    $response = \Livewire\Livewire::mount('video.create');
    $html = $response->html();
    $_instance->logRenderedChild('SKPg0WA', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
