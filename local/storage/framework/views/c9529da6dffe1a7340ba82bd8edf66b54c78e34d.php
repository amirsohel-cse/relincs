...
<?php if($viewType == 'default'): ?>
    ...
    <div>
        <div class="message-card">
            <div class="image-file chat-image" style="width: 250px; height: 150px;background-image: url('<?php echo e(asset('storage/storage/'.config('chatify.attachments.folder').'/'.$attachment[0])); ?>')">
            </div>
        </div>
    </div>
    <?php endif; ?>
...
<?php if($viewType == 'sender'): ?>
    ...
    <?php endif; ?>
<?php endif; ?>
<?php /**PATH /var/www/relincs.com/htdocs/local/resources/views/vendor/Chatify/layouts/messageCard.blade.php ENDPATH**/ ?>