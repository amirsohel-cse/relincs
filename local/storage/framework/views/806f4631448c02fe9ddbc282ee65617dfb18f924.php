...
} elseif ($_instance->childHasBeenRendered('l1663243858-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l1663243858-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l1663243858-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l1663243858-0');
} else {
    $response = \Livewire\Livewire::mount('join', ['user_id' => $i->user_id]);
    $html = $response->html();
    $_instance->logRenderedChild('l1663243858-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                            </div>
            ...
            <div class="w-full" wire:target="find" wire:loading>
                <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.loading','data' => ['classSvg' => 'w-12 h-12','classText' => 'text-xl']]); ?>
<?php $component->withName('loading'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['classSvg' => 'w-12 h-12','classText' => 'text-xl']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
...
<?php /**PATH /var/www/relincs.com/htdocs/local/resources/views/livewire/findvideo.blade.php ENDPATH**/ ?>