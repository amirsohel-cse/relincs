<div class="w-full">
    <?php $__env->startSection('title'); ?> List Media of Hubs <?php $__env->stopSection(); ?>

     <?php $__env->slot('header', null, []); ?> 
        <?php echo e(__('List Media of Hubs')); ?>
                        ...
                        <tbody class="w-full">
                            ...
                            <tr class="border-b border-gray-100 w-full">
                                <td class="text-center py-3 border-r border-gray-100 w-full">
                                    ...
                                    <a href="<?php echo e(route('watch.hubs.media', $i->uid)); ?>"
                                        ...
                                        <div
                                            ...
                                            <div
                                                ...
                                                <img src="<?php echo e(env('AWS_BUCKET_URL').'hubs/media/'.$i->uid.'/'.$i->thumbnail_image); ?>"
                                ...
                                <td class="text-center py-3 w-full">
                                    ...
                                    <div class="flex flex-col mx-3 w-full">
                                        <div
                                            ...
                                            <a href="<?php echo e(route('dash.update.media.hubs', ['hubmedia' => $i->uid])); ?>"
...
<?php /**PATH /var/www/relincs.com/htdocs/local/resources/views/livewire/hubs/media/list-media.blade.php ENDPATH**/ ?>