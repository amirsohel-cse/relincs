...
} elseif ($_instance->childHasBeenRendered('xOvutsw')) {
    $componentId = $_instance->getRenderedChildComponentId('xOvutsw');
    $componentTag = $_instance->getRenderedChildComponentTagName('xOvutsw');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('xOvutsw');
} else {
    $response = \Livewire\Livewire::mount('search-engine');
    $html = $response->html();
    $_instance->logRenderedChild('xOvutsw', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        </div>
...
<?php /**PATH /var/www/relincs.com/htdocs/local/resources/views/layouts/explorer.blade.php ENDPATH**/ ?>