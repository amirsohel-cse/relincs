                ...
                <li class="dropdown">
                    <a class="nav-link dropdown-toggle nav-user" data-bs-toggle="dropdown" href="#" role="button"
                        ...
                        <div class="d-flex align-items-center">
                            <img src="<?php echo e(asset('assets/admin/images/users/user-4.jpg')); ?>" alt="profile-user" class="rounded-circle me-2 thumb-sm" />
                            <div>
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <a class="dropdown-item" href="<?php echo e(route('logout')); ?>" onclick="event.preventDefault(); document.getElementById('logout-form').submit();"><i class="ti ti-power font-16 me-1 align-text-bottom"></i> Logout</a>
