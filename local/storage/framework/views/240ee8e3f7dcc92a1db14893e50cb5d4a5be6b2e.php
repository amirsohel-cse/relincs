                                ...
                                <div class="swiper-slide w-full">
                                    <div class="w-full relative" wire:ignore>
                                        <video id="<?php echo e($item->id); ?>"
                                            ...
                                            <source src="<?php echo e(env('AWS_BUCKET_URL').'media/'.$item->uid.'/'.$item->processed_file); ?>" type="application/x-mpegURL" />
                                            <p class="vjs-no-js">
                ...
                <div class="bg-gradient-to-tr from-sky via-sky to-indigo-600 p-1 rounded-full">
                    <a href="<?php echo e(route('show.hubs' , $data->uid)); ?>"
                        ...
                        <img class="h-32 w-32 rounded-full"
                            src="<?php echo e(env('AWS_BUCKET_URL') .'public/profile_hubs/'. $data->profile); ?>" alt="cute kitty" />
...
<?php endif; ?>
<?php /**PATH /var/www/relincs.com/htdocs/local/resources/views/index.blade.php ENDPATH**/ ?>