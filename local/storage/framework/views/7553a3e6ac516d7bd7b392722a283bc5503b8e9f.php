                                ...
                                <div class="card-body p-0 auth-header-box">
                                    <div class="text-center p-3">
                                        <a href="index.html" class="logo logo-admin">
                                            <img src="<?php echo e(asset('img/favicon.png')); ?>" height="50" alt="logo" class="auth-logo">
                                        </a>
...
</div><?php /**PATH C:\laragon\www\relincs\local\resources\views/livewire/admin/auth/login-component.blade.php ENDPATH**/ ?>