...
} elseif ($_instance->childHasBeenRendered('l3951203870-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l3951203870-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l3951203870-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l3951203870-0');
} else {
    $response = \Livewire\Livewire::mount('likedislike', ['video' => $media]);
    $html = $response->html();
    $_instance->logRenderedChild('l3951203870-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                            ...
                            <div class="flex flex-row justify-between items-center border-b border-gray-100 pb-3">
                                <div class="flex justify-center items-center">
                                    <a href="<?php echo e(route('gu.profile.show' , ['name' => $user->id ])); ?>" class="w-full h-full lg:block hidden">
                                        <img src="<?php echo e($this->profile_published()); ?>" alt="picture user"
...
} elseif ($_instance->childHasBeenRendered('l3951203870-1')) {
    $componentId = $_instance->getRenderedChildComponentId('l3951203870-1');
    $componentTag = $_instance->getRenderedChildComponentTagName('l3951203870-1');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l3951203870-1');
} else {
    $response = \Livewire\Livewire::mount('subscribe', ['user_id' => $media->user_id]);
    $html = $response->html();
    $_instance->logRenderedChild('l3951203870-1', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                </div>
...
} elseif ($_instance->childHasBeenRendered('l3951203870-2')) {
    $componentId = $_instance->getRenderedChildComponentId('l3951203870-2');
    $componentTag = $_instance->getRenderedChildComponentTagName('l3951203870-2');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l3951203870-2');
} else {
    $response = \Livewire\Livewire::mount('add-comment-video',['data' => $media,'col' => 0]);
    $html = $response->html();
    $_instance->logRenderedChild('l3951203870-2', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                            </div>
                ...
                <div class="flex justify-start lg:col-span-4 col-span-12">
                    <div class="flex flex-col lg:space-x-2 space-y-3 lg:w-auto w-full">
                        <div></div>
                        <?php $__empty_1 = true; $__currentLoopData = App\Models\Media::where("id",'!='.$media->id)->select('user_id','title','uid','views','created_at','thumbnail_image')->take('10')->latest()->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <?php
...
<?php /**PATH /var/www/relincs.com/htdocs/local/resources/views/livewire/watchmedia.blade.php ENDPATH**/ ?>