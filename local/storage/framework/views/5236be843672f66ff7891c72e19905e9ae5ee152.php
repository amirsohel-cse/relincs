                                    ...
                                    <?php if($medias->count() > 0): ?>
                                        <?php $__currentLoopData = $medias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $media): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                <td><?php echo e($sl++); ?></td>
                                                <td>
                                                    <img src="<?php echo e(env('AWS_BUCKET_URL').'hubs/media/'.$media->uid.'/'.$media->thumbnail_image); ?>"
                                                ...
                                                <td style="text-align: center;">
                                                    ...
                                                    <div class="dropdown-menu" style="width: auto;">
                                                        <a href="<?php echo e(route('watch.hubs.media', ['media'=>$media->uid])); ?>"
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\laragon\www\relincs\local\resources\views/livewire/admin/hub/hub-media-component.blade.php ENDPATH**/ ?>