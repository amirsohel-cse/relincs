<div class="w-full">
    ...
    <ul class="w-full mt-2">
        <div class="addevent px-4">
            ...
            <?php if($notification->data['type'] === 'like'): ?>
            <li class="flex w-full border-b pb-1 mt-1">
                <div class="flex items-center hover:bg-gray-100 rounded-lg px-1 py-1 cursor-pointer">
                    <div class="flex flex-shrink-0 items-end relative">
                        <a title="go to profile"
                            ...
                            <img class="h-14 w-14 rounded-full"
                                src="<?php echo e(asset('storage/profile_image/'.$notification->data['image_profile'])); ?>"
                    ...
                    <div class="ml-3">
                        <span class="font-medium text-sm"><?php echo e($notification->data['title']); ?></span>
                        <p class="lg:text-sm text-sm text-bold">
                            <?php echo e($notification->data['username'].','.$notification->data['message']); ?></p>
                        <span
                            class="text-xs text-blue-900 text-opacity-60 font-semibold"><?php echo e($notification->created_at->diffForHumans()); ?></span>
                    </div>
                </div>
            </li>
            <?php elseif($notification->data['type'] === 'comment'): ?>
            <li class="flex w-full border-b pb-1 mt-1">
                <div class="flex items-center hover:bg-gray-100 rounded-lg px-1 py-1 cursor-pointer">
                    <div class="flex flex-shrink-0 items-end relative">
                        <a title="go to profile"
...
<?php /**PATH /var/www/relincs.com/htdocs/local/resources/views/components/notification.blade.php ENDPATH**/ ?>