<?php $__env->startSection('metas'); ?>
    ...
    <meta name="image" content="<?php echo e(env('AWS_BUCKET_URL').'hubs/media/'.$media->uid.'/'.$media->thumbnail_image); ?>">
                            ...
                            <div class="flex flex-row justify-between items-center border-b border-gray-100 pb-3">
                                <div class="flex justify-center items-center">
                                    <div class="w-full h-full">
                                        <img src="<?php echo e(env('AWS_BUCKET_URL').'public/profile_hubs/'.$hub->profile); ?>" alt="picture user"
...
<?php /**PATH C:\laragon\www\relincs\local\resources\views/livewire/watch-hub-media.blade.php ENDPATH**/ ?>