                    ...
                    <div class="bg-white border border-white shadow-lg  rounded-3xl p-4 m-4">
                        <div class="flex-none sm:flex justify-center items-center">
                            <a href="<?php echo e(route('gu.profile.show' , ['name' => $user->id ])); ?>"
                                ...
                                <img src="<?php echo e($user->profile()); ?>" alt="<?php echo e($user->username); ?>"
...
} elseif ($_instance->childHasBeenRendered('l717891923-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l717891923-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l717891923-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l717891923-0');
} else {
    $response = \Livewire\Livewire::mount('following', ['user_id' => $user->id]);
    $html = $response->html();
    $_instance->logRenderedChild('l717891923-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                    </div>
...
</div><?php /**PATH /var/www/relincs.com/htdocs/local/resources/views/livewire/explorer/profiles.blade.php ENDPATH**/ ?>