    ...
    <div class="flex justify-between items-start">
        ...
        <div class="flex space-x-2 items-center" wire:loading.class="opacity-50" wire:target="mark()">
            <button type="button" class="focus:outline-none" wire:click="mark">
                <svg class="w-8 h-8 text-gray-700  <?php if($marked): ?> text-gray-900 fill-current transition duration-200  <?php endif; ?>"
...
<?php /**PATH /var/www/relincs.com/htdocs/local/resources/views/livewire/voting.blade.php ENDPATH**/ ?>