...
} elseif ($_instance->childHasBeenRendered('l602158859-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l602158859-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l602158859-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l602158859-0');
} else {
    $response = \Livewire\Livewire::mount('all-comment', ['video' => $wall]);
    $html = $response->html();
    $_instance->logRenderedChild('l602158859-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('l602158859-1')) {
    $componentId = $_instance->getRenderedChildComponentId('l602158859-1');
    $componentTag = $_instance->getRenderedChildComponentTagName('l602158859-1');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l602158859-1');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('l602158859-1', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                    <?php endif; ?>
...
<?php /**PATH /var/www/relincs.com/htdocs/local/resources/views/livewire/watch-hub-wall.blade.php ENDPATH**/ ?>