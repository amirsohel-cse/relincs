<div class="w-full">
    ...
    <?php $__env->stopSection(); ?>
     ...
     <?php $__env->slot('header', null, []); ?> 
        ...
        <?php echo e('Edit media '.$hubmedia->title); ?>
    ...
    <div class="w-full" wire:target="update" wire:loading.class="opacity-50">
        <form wire:submit.prevent="update">
            <div class="relative flex flex-col w-full md:px-10 px-3" <?php if($this->hubmedia->processed_persentage < 100): ?>
                    wire:poll <?php endif; ?>>
                    <div class=" flex w-full flex-col space-y-3">
                        <div class="flex justify-between items-center w-full mb-3">
                            <div class="w-5/12">
                                Cover Video :
                                <img src="<?php echo e($cover ? $cover->temporaryUrl() : asset($this->hubmedia->getThumbnailAttribute())); ?>"
                                    alt="<?php echo e($this->hubmedia->title); ?>" class="w-96 h-60 object-cover">
                            </div>
                            <div class="w-4/12">
                            ...
                            <div class=" flex flex-col w-3/12">
                                <p class="text-gray-600 font-base">
                                    Processeing
                                    <span class="font-medium text-gray-600">(<?php echo e($this->hubmedia->processed_persentage); ?>)%</span>
                                </p>
...
<?php endif; ?>
                            <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.input','data' => ['id' => 'title','class' => 'block mt-2 w-full','type' => 'text','wire:model' => 'hubmedia.title','required' => true,'autocomplete' => 'current-title']]); ?>
<?php $component->withName('input'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['id' => 'title','class' => 'block mt-2 w-full','type' => 'text','wire:model' => 'hubmedia.title','required' => true,'autocomplete' => 'current-title']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
...
<?php /**PATH C:\laragon\www\relincs\local\resources\views/livewire/hubs/media/edit.blade.php ENDPATH**/ ?>