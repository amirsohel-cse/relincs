...
} elseif ($_instance->childHasBeenRendered('l2887889705-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l2887889705-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l2887889705-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l2887889705-0');
} else {
    $response = \Livewire\Livewire::mount('join', ['user_id' => $i->user_id]);
    $html = $response->html();
    $_instance->logRenderedChild('l2887889705-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                                        </div>
...
<?php /**PATH D:\laragon\www\relincs\local\resources\views/livewire/findvideo.blade.php ENDPATH**/ ?>