...
} elseif ($_instance->childHasBeenRendered('3KAjFCb')) {
    $componentId = $_instance->getRenderedChildComponentId('3KAjFCb');
    $componentTag = $_instance->getRenderedChildComponentTagName('3KAjFCb');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('3KAjFCb');
} else {
    $response = \Livewire\Livewire::mount('join', ['user_id' => $data->user_id]);
    $html = $response->html();
    $_instance->logRenderedChild('3KAjFCb', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                    </div>
...
<?php endif; ?>
<?php /**PATH /var/www/relincs.com/htdocs/local/resources/views/hubs/show.blade.php ENDPATH**/ ?>