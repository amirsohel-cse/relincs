                ...
                <div class="w-full md:py-10 md:col-span-3 col-span-12">
                    <div class="flex flex-col justify-center items-center space-y-3">
                        <div class="cursor-pointer">
                            <img src="<?php echo e($user->profile()); ?>" onerror="this.onerror=null;this.src='https://relincsca.s3.amazonaws.com/public/profile_image/62a21b9f0e60cElizabeth.png';"
...
} elseif ($_instance->childHasBeenRendered('l1429630535-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l1429630535-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l1429630535-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l1429630535-0');
} else {
    $response = \Livewire\Livewire::mount('following', ['user_id' => $user->id]);
    $html = $response->html();
    $_instance->logRenderedChild('l1429630535-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                            </div>
...
<?php /**PATH E:\xampp\htdocs\relincs\local\resources\views/livewire/profile/profile-u-ser.blade.php ENDPATH**/ ?>