 ...
 if (messenger != 0) {
   ...
   $.ajax({
     ...
     success: (data) => {
       ...
       $(".messenger-infoView")
         .find(".avatar")
         .css("background-image", 'url("https://relincs.com/storage/storage/profile_image/' + data.fetch.image_profile + '")');
       $(".header-avatar").css(
         "background-image",
         'url("https://relincs.com/storage/storage/profile_image/' + data.fetch.image_profile + '")'
       );
       $(".usernames").html(data.fetch.username);
       ...
       messageInput.focus();
       // update info in view
       $(".vatars").html(`<img src='https://relincs.com/storage/storage/profile_image/'${data.fetch.image_profile}`);
